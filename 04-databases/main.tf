...
resource "null_resource" "mongodb" {
  ...
  provisioner "remote-exec" {
    inline = [ 
        ...
        "sudo sh /tmp/bootstrap.sh mongodb dev"  #we r passing component and env values here
...
resource "null_resource" "redis" {
  ...
  provisioner "remote-exec" {
    inline = [ 
        "chmod +x /tmp/bootstrap.sh",
        "sudo sh /tmp/bootstrap.sh redis dev"  #we r passing component and env values here
...
resource "null_resource" "mysql" {
  ...
  provisioner "remote-exec" {
    inline = [ 
        "chmod +x /tmp/bootstrap.sh",
        "sudo sh /tmp/bootstrap.sh mysql dev"  #we r passing component and env values here
...
resource "null_resource" "rabbitmq" {
  ...
  provisioner "remote-exec" {
    inline = [ 
        "chmod +x /tmp/bootstrap.sh",
        "sudo sh /tmp/bootstrap.sh rabbitmq dev"  #we r passing component and env values here
